...
View this code at https://inventwithpython.com/bigbookpython/project5.html#
...
# We can't print to the last column on Windos without it adding a
...
def main():
    ...
    while True: # Main program loop
        for logo in logos: # Handle each logo in the logos list.
            ...
            # See if the logo bounces off the bottome edge:
            ...
            if logo[DIR] != originalDirection:
                # Change color when the logo counces:
                logo[COLOR] = random.choice(COLORS)
            
            # Move the logo. (X moves by 2 because the terimanl
            # characters are twices as tall as they are wide.)
