'''Conway\'s Game of Life, by Al Swiegart al@inventwithpython.com
The classic cellular automata simulation. Press Ctrl-C to stop.
More info at: htts://en.wikipedia.org/wiki/Conway_Game_of_Life
...
WIDTH = 200                                 # The width of the cell grid
HEIGHT = 35                                 # The height of the cell grid.

                                            # (!) Try changing ALIVE to '#' or another character:
ALIVE = 'O'                                 # The character representing a living cell.
                                            # (!) Try changing DEAD to '.' or another chacter:
DEAD = ' '                                  # The character representing a dead cell. 

                                            # (!) Thy chaning ALIVE to '|' and DEAD TO '-'
...
while True:                                 # Main program loop
    ...
    for x in range(WIDTH):
        for y in range(HEIGHT):
                                            # Get the neighboring coordnates of (x, y), even if they
