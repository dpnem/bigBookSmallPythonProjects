...
View this code at https://inventwithpython.com/bigbookpython/project9.html#
Tags: large, geginner, game, two-player"""
...
their eyes during this). The first plyaer then says "There is a carrot
...
print()
input('Then press Enter to conitnue...')
